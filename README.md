...
We try this out, for instance, over multiple years for Hilo, the largest town in Hawaii, to check if the climate is stable. Quite so. ![climate in Hilo for different years](Hilo.png)
